<template>
  <fhFilters />
  <section
    class="my-4 py-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-10 transition-all"
  >
    <fhCatalogItem
...
<script>
import fhFilters from "./fhFilters.vue";
import fhCatalogItem from "./fhCatalogItem.vue";
export default {
  name: "fhCatalog",
  data() {
    return {
      ...
      services: [
        {
          ...
          description:
            "Абонемент на посещение любого спортивного клуба сети Fitness House в течении 1 года но не более 100 занятий в свбодное время.",
          image:
        ...
        },
        {
          ...
          description:
            "Абонемент на посещение одного спортивного клуба сети Fitness House в течении 1 года но не более 100 занятий в утреннее время.",
          image:
        ...
        },
        {
          ...
          description:
            "Абонемент на посещение определенного количества занятий детской секции в одном из спортивных клубов сети Fitness House с бассейном в течении 6 месяцев.",
          image:
            "https://cdn.pixabay.com/photo/2016/03/27/21/55/sunglasses-1284419_960_720.jpg",
          properties: [
            {
              title: "Количество занятий",
              value: "18 занятий",
        ...
        },
        {
          ...
          description:
            "Абонемент на посещение одного спортивного клуба сети Fitness House в составе групповых секций в вечернее время.",
          image:
